    ...
    if (firstName && lastName) {
        ...
        suggestions.forEach((suggestion) => {
            ...
            suggestionSpan.addEventListener("click", (event) => {
                event.stopPropagation(); // Prevent blur from clearing suggestions before the click is registered
...
// Fix: Delay clearing suggestions on blur so click events can register
usernameInput.addEventListener("blur", () => {
    ...
    }, 200); // Delay to allow click event to be registered
});